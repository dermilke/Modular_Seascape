...
list_datatable$table %>%
  ...
  mutate(Group = ordered(Group, levels = levels(list_datatable$table$Group), 
                         labels = str_replace_all(levels(list_datatable$table$Group), pattern = "Unknown Marinimicrobia \\(SAR406 clade\\) \\- Unknown Marinimicrobia \\(SAR406 clade\\)",
